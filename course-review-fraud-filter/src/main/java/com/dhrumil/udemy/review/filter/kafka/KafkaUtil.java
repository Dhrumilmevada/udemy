package com.dhrumil.udemy.review.filter.kafka;
...
import com.dhrumil.udemy.review.filter.main.AppConfig;
...
public class KafkaUtil {
  ...
  public KafkaUtil(AppConfig appConfig) {
    ...
    kafkaConfig.put(AdminClientConfig.BOOTSTRAP_SERVERS_CONFIG, appConfig.getBootstrapServers());
